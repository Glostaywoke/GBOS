...
**Live tool:** [Glostaywoke.github.io/gbos-patcher](https://yourusername.github.io/gbos-patcher)
...
1. Open the [live page](https://Glostaywoke.github.io/gbos-patcher) (or open `index.html` locally)
...
```
git clone https://github.com/yourusername/gbos-patcher
cd gbos-patcher
open index.html
```
